...
param bookworm_basket_identity_outputs_id string

param bookworm_basket_identity_outputs_clientid string

param bookworm_basket_containerport string
...
resource bookworm_basket 'Microsoft.App/containerApps@2024-03-01' = {
  ...
  properties: {
    configuration: {
      secrets: [
        {
          name: 'connectionstrings--redis'
          identity: bookworm_basket_identity_outputs_id
      ...
      ingress: {
        external: false
        targetPort: bookworm_basket_containerport
        transport: 'http'
      }
      registries: [
        {
    ...
    template: {
      containers: [
        {
          image: bookworm_basket_containerimage
          name: 'bookworm-basket'
          env: [
            {
            ...
            {
              name: 'HTTP_PORTS'
              value: bookworm_basket_containerport
            }
            {
            ...
            }
            {
              ...
              value: bookworm_basket_identity_outputs_clientid
            }
          ]
        }
      ]
