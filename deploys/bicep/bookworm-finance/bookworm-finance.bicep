...
param bookworm_finance_identity_outputs_id string

param bookworm_finance_identity_outputs_clientid string

param bookworm_finance_containerport string
...
param bookworm_finance_containerimage string
...
resource bookworm_finance 'Microsoft.App/containerApps@2024-03-01' = {
  ...
  properties: {
    configuration: {
      secrets: [
        {
          name: 'connectionstrings--financedb'
          identity: bookworm_finance_identity_outputs_id
      ...
      ingress: {
        external: false
        targetPort: bookworm_finance_containerport
        transport: 'http'
      }
      registries: [
        {
    ...
    template: {
      containers: [
        {
          image: bookworm_finance_containerimage
          name: 'bookworm-finance'
          env: [
            {
            ...
            {
              name: 'HTTP_PORTS'
              value: bookworm_finance_containerport
            }
            {
            ...
            }
            {
              ...
              value: bookworm_finance_identity_outputs_clientid
            }
          ]
        }
      ]
  ...
  identity: {
    ...
    userAssignedIdentities: {
      '${bookworm_finance_identity_outputs_id}': { }
