...
readsFrom:
    - id: NotificationDatabase
      version: 1.0.0
attachments:
  - url: https://foxminchan.github.io/BookWorm/docs/architecture-decisions/adr-011-rabbitmq-message
    ...
    icon: FileTextIcon
  - url: https://foxminchan.github.io/BookWorm/docs/architecture-decisions/adr-014-sendgrid-email-provider
    title: ADR-014 - SendGrid Email Provider
    description: Learn more about the SendGrid email provider choice for the Notification Service.
    type: 'architecture-decisions'
    icon: FileTextIcon
---
