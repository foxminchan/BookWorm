...
sidebar_position: 1
title: Overview
description: Static decomposition of BookWorm system into building blocks, services, and components with their dependencies
keywords: [building block view, system decomposition, microservices structure, component architecture, service boundaries]
last_update:
  author: Nhan Nguyen
---
