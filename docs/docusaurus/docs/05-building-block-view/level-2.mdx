...
sidebar_position: 3
title: Level 2
description: Detailed internal structure of core BookWorm services including Catalog, Ordering, Basket, and Chat services
keywords: [service decomposition, component diagram, internal structure, application layer, infrastructure layer, domain layer]
last_update:
  author: Nhan Nguyen
---
