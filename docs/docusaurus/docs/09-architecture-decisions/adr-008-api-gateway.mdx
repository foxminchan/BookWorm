...
Implement an **API Gateway pattern** using **YARP (Yet Another Reverse Proxy)** integrated with **Aspire** for service discovery and routing, providing a unified entry point for all BookWorm microservices.
