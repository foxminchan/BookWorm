...
description: Selection of .NET Aspire for cloud-native orchestration and built-in observability
keywords: [ADR-003, .NET Aspire, cloud-native, service orchestration, observability, telemetry]
last_update:
  author: Nhan Nguyen
---
