...
| **Chat**         | Query-focused with conversation history | Streaming AI responses via SSE               | PostgreSQL                      |
...
- **Message Broker**: Kafka for durable, ordered, replayable message delivery
- **Event Framework**: WolverineFx for .NET integration, outbox/inbox, and saga patterns
