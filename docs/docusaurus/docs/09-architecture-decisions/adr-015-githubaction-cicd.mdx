...
2. **Security Scanning**: Snyk for vulnerability scanning and dependency analysis, Gitleaks for
   secrets detection
...
├── actions/
│   ├── setup/                      # Environment setup (.NET, pnpm, tools)
...
- **pnpm** setup for JavaScript/TypeScript tooling
