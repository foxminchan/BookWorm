...
gantt
    ...
    .NET Aspire            :done, foundation3, 2024-08-01, 30d
...
| [ADR-003](./adr-003-aspire-cloud-native)        | .NET Aspire for Cloud-Native Development | Accepted | High   |
...
graph TD
    ...
    G[ADR-003: .NET Aspire] --> H[ADR-007: Azure Container Apps]
