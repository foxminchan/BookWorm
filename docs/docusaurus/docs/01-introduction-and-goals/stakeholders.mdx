...
title: Stakeholders
description:
  Key stakeholders, their roles, and expectations for BookWorm architecture and documentation
keywords:
  [
    stakeholders,
    project owner,
...
While the BookWorm project is currently a solo development effort, the following external
stakeholders still influence architectural decisions:
...
- **Frontend Developer**: Implement Next.js 16 + React 19 applications (Storefront & Backoffice)
  with Turbo monorepo
- **Backend Developer**: Build .NET 10 APIs, business logic, and data management across 8
  microservices
- **DevOps Engineer**: Set up CI/CD (GitHub Actions for frontend, Aspire for backend), Azure
  deployment, and monitoring
- **QA Engineer**: Write TUnit tests, perform quality assurance, and bug fixing
- **Database Administrator**: Design PostgreSQL data models and optimize performance
- **AI Engineer**: Integrate Azure OpenAI services with Semantic Kernel and Microsoft Agents AI
  Framework
