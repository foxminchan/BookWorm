...
sidebar_position: 13
title: Glossary
description: Comprehensive glossary of technical terms, concepts, and acronyms used throughout BookWorm's architecture documentation
keywords: [glossary, technical terms, architecture terminology, microservices, DDD, CQRS, event sourcing, cloud-native]
last_update:
  author: Nhan Nguyen
---
