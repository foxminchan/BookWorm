...
title: Configuration
description:
  Comprehensive configuration system with Aspire features, environment variables, and Azure App
  Configuration
keywords:
  [
    configuration,
...
The BookWorm application uses a comprehensive configuration system built on .NET's configuration
framework, enhanced with Aspire-specific features and custom extensions.
...
- **Kafka Settings** - Broker connection, topic naming, and consumer group configuration
- **WolverineFx Options** - Message routing, outbox/inbox policies, and serialization settings
