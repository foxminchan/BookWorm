...
description:
  Detailed service configurations, container specifications, and deployment parameters for BookWorm
  microservices
keywords:
  [
...
This level provides detailed information about individual services, their container configurations,
...
| **Kafka**      | confluentinc/cp-kafka | latest  | Data volume | WolverineFx broker |
...
- **AI Models**: Azure OpenAI (GPT-4o-mini, text-embedding-3-large)
