...
<img loading="lazy" src="https://raw.githubusercontent.com/foxminchan/BookWorm/refs/heads/main/assets/architecture.png" alt="BookWorm Architecture Overview" className="my-6 rounded-lg shadow-md" />
