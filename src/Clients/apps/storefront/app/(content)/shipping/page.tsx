      ...
      <main className="grow">
        ...
        <section className="py-32 container mx-auto px-4 text-center border-b">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto text-pretty">
            We're committed to getting your books to your doorstep quickly and safely. Free shipping on orders over $50.
          </p>
        </section>
        ...
        <section className="py-16 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-serif font-medium mb-4">Free Shipping on Orders Over $50</h2>
            <p className="text-lg opacity-90 max-w-xl mx-auto">
              No hidden fees. No minimum order requirements for standard shipping. Just books, delivered to you.
            </p>
          </div>
        </section>
        ...
        <section className="py-24 container mx-auto px-4">
          <h2 className="text-4xl font-serif font-medium mb-16 text-center">Shipping Options</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              return (
                <Card key={idx} className="border-none bg-secondary hover:shadow-lg transition-all">
                  <CardContent className="pt-8 space-y-4 text-center">
                    <Icon className="size-12 text-primary mx-auto" />
                    <h3 className="font-serif font-medium text-lg">{option.title}</h3>
        ...
        <section className="py-24 bg-secondary">
          <div className="container mx-auto px-4">
            <h2 className="text-4xl font-serif font-medium mb-12 text-center">Delivery Information</h2>
            <div className="max-w-3xl mx-auto space-y-8">
              {[
                ...
                <div key={idx} className="border-b border-primary/20 pb-8 last:border-b-0">
                  <h3 className="font-serif font-medium text-xl mb-3">{item.title}</h3>
        ...
        <section className="py-24 container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-4xl font-serif font-medium mb-8">Damaged or Lost Packages?</h2>
            <div className="bg-secondary p-8 rounded-lg space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                While we take every precaution to ensure your books arrive safely, accidents do happen. If your package
                arrives damaged or goes missing, contact our customer support team immediately.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                We'll work quickly to resolve the issue—whether that means reshipping your order, issuing a refund, or
        ...
        <section className="py-24 bg-secondary">
          <div className="container mx-auto px-4">
            <h2 className="text-4xl font-serif font-medium text-center mb-16">Frequently Asked Questions</h2>
