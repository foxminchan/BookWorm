...
internal sealed class DeletePublisherValidator : AbstractValidator<DeletePublisherCommand>
{
...
internal sealed class PublisherValidator : AbstractValidator<Guid>
{
