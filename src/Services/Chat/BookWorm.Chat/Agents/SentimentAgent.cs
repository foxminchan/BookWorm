...
public static class SentimentAgent
{
    ...
    private const string Instructions = """
        You are a sentiment analysis assistant for BookWorm bookstore. Your role is to evaluate the emotional tone of user messages that have been processed by the Language Agent.

        **Sentiment Analysis:**
        - Analyze the English text received from the Language Agent
