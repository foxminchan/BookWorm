...
{
    /// <inheritdoc />
    public partial class Migrate_To_Wolverine : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    timeout_retry_count = table.Column<int>(type: "integer", nullable: false),
                    is_timeout_cancelled = table.Column<bool>(type: "boolean", nullable: false),
        ...
        {
            migrationBuilder.DropTable(name: "order_sagas");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    place_order_timeout_token_id = table.Column<Guid>(type: "uuid", nullable: true),
