...
{
    internal partial class BuyerEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            createdDate.AddAnnotation("Relational:DefaultValue", new DateTime(2024, 7, 22, 11, 37, 55, 670, DateTimeKind.Utc).AddTicks(4920));

            var name = runtimeEntityType.AddProperty(
                "Name",
                typeof(string),
                propertyInfo: typeof(Buyer).GetProperty("Name", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(Buyer).GetField("<Name>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                propertyAccessMode: PropertyAccessMode.Property,
                maxLength: 20);
        ...
        updateDate.AddAnnotation("Relational:DefaultValue", new DateTime(2024, 7, 22, 11, 37, 55, 670, DateTimeKind.Utc).AddTicks(5175));
        ...
        key.AddAnnotation("Relational:Name", "pk_buyers");
