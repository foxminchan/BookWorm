...
- **Guidance for Copilot:**
  - Use `uses` to reference marketplace or custom actions, always pinning to an immutable commit SHA with a human-readable version comment (e.g., `uses: actions/checkout@9c091bb21b7c1c1d1991bb908d89e4e9dddfe3e0 # v7.0.0`). This is especially critical for third-party actions where you have no control over whether a tag gets moved.
