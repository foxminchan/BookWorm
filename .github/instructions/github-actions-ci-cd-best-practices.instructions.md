...
- **Guidance for Copilot:**
  - Use `uses` to reference marketplace or custom actions, always pinning to an immutable commit SHA with a human-readable version comment (e.g., `uses: actions/checkout@3d3c42e5aac5ba805825da76410c181273ba90b1 # v7.0.1`). This is especially critical for third-party actions where you have no control over whether a tag gets moved.
